...
export const KATEX_OPTIONS = new InjectionToken<MarkedKatexOptions>('KATEX_OPTIONS');

/* eslint-disable */
export interface MarkedKatexOptions extends KatexOptions {
  /**
   * If `true`, math will be rendered in non-standard markdown
   * format, that is, without spaces before and after $ or $$.
   *
   * @default false
   */
  nonStandard?: boolean
...
interface KatexOptions {
   ...
   * @default "warn"
   */
  strict?: boolean | 'warn' | 'error' | 'ignore' | any;
  /**
   ...
   * @default false
   */
  trust?: boolean | ((context: any) => boolean) | undefined;
  /**
