import {h,X,T as Tn,q as Gn,L as Le,Z as Z4,H as H4,z as z4,t as q4,G as G4,K as KS,D as Dc,B as Bh,F as Fh,j as jc,b as Gb,u as Tg,w as wT,v as Mg,P as PC,x as Sg,C as Cg,I as Ib,y as tT,S as Sb,f as fn,c as zb,d as BC,A as Zb,E as yr$1,$ as $D,J as Ea,N as VD,a as Bc,Q as $g,Y as YS,U as FT}from'./main-SSWFTBEC.js';import {y as yr,Z as Zt,v as vr,_ as _n,a as at,F as Fi,I as Io,S as So,s as so}from'./chunk-DFhBq1M3.js';import {U,e as et}from'./chunk-BcD9tgoV.js';function ie(te,s){if(te&1){let m=KS();Dc(0,"button",29),Bc("click",function(){Tg(m);let p=YS();return Mg(p.onCopyToClipboard())}),$g(),Dc(1,"svg",30),jc(2,"path",31),Fh()();}}var d=class d{constructor(){this.elementRef=h(X);this.snackbar=h(Tn);this.clipboardButton=Gn;this.emojiMarkdown="# I :heart: ngx-markdown";this.katexMarkdown="#### `katex` directive example\n\n```latex\nf(x) = \\int_{-\\infty}^\\infty \\hat f(\\xi) e^{2 \\pi i \\xi x} d\\xi\n```\n\n$f(x) = \\int_{-\\infty}^\\infty \\hat f(\\xi) e^{2 \\pi i \\xi x} d\\xi$";this.mermaidMarkdown="```mermaid\ngraph TD;\n  A-->B;\n  A-->C;\n  B-->D;\n  C-->D;\n```";this.mermaidOptions={fontFamily:"inherit",theme:"dark"};}ngOnInit(){this.setHeadings();}onCopyToClipboard(){this.snackbar.open("Copied to clipboard via ng-template!",void 0,{duration:3e3,horizontalPosition:"right",verticalPosition:"bottom"});}setHeadings(){let s=[];this.elementRef.nativeElement.querySelectorAll("h2").forEach(m=>s.push(m)),this.headings=s;}};d.\u0275fac=function(m){return new(m||d)},d.\u0275cmp=Le({type:d,selectors:[["app-plugins"]],features:[Zb([yr$1({clipboardOptions:{provide:$D,useValue:{}},sanitize:{provide:VD,useValue:Ea}})])],decls:153,vars:34,consts:[["buttonTemplate",""],[3,"headings"],["id","emoji"],[3,"src"],["fxLayout","column","fxLayout.gt-sm","row","fxLayoutGap","16px"],["appearance","fill","color","accent","fxFlex.gt-sm","calc(50% - 8px)"],["matInput","","cdkTextareaAutosize","true",3,"ngModelChange","ngModel"],["emoji","","fxFlex.gt-sm","calc(50% - 8px)",3,"data"],["emoji",""],["id","line-numbers"],["lineNumbers",""],["lineNumbers","",3,"start"],["id","line-highlight"],["lineHighlight","",3,"line","lineOffset"],["id","command-line"],["commandLine","",3,"user","host","src"],["commandLine","",3,"user","host","output","src"],["commandLine","",3,"prompt","output","src"],["commandLine","",3,"prompt","filterOutput","src"],["id","katex"],["katex","","fxFlex.gt-sm","calc(50% - 8px)",3,"data"],["id","mermaid"],["mermaid","","fxLayoutAlign","center center","fxFlex.gt-sm","calc(50% - 8px)",3,"data","mermaidOptions"],["id","clipboard"],["clipboard",""],["clipboard","",1,"btn-clipboard-toolbar"],["clipboard","",1,"btn-clipboard-default"],["clipboard","",3,"clipboardButtonComponent"],["clipboard","",3,"clipboardButtonTemplate"],[1,"btn-clipboard",3,"click"],["viewBox","0 0 24 24",2,"width","16px","height","16px"],["fill","#fff","d","M19,3H14.82C14.4,1.84 13.3,1 12,1C10.7,1 9.6,1.84 9.18,3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3M12,3A1,1 0 0,1 13,4A1,1 0 0,1 12,5A1,1 0 0,1 11,4A1,1 0 0,1 12,3M7,7H17V5H19V19H5V5H7V7Z"]],template:function(m,a){if(m&1){let p=KS();Dc(0,"app-scrollspy-nav-layout",1)(1,"h1"),Bh(2,"Plugins"),Fh(),Dc(3,"markdown"),Bh(4," Before to use any plugin, make sure you've installed the required libraries by following the [installation](/get-started#installation) section of the __Get Started__ page. "),Fh(),Dc(5,"section")(6,"h2",2),Bh(7,"Emoji plugin"),Fh(),Dc(8,"markdown"),Bh(9,`
