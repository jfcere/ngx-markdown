...
`],encapsulation:2})}return n})();var ut=(()=>{class n{static ɵfac=function(i){return new(i||n)};static ɵmod=Ee$1({type:n});static ɵinj=ge({imports:[O6,Mn,no]})}return n})();var Fn=(()=>{class n{static ɵfac=function(i){return new(i||n)};static ɵcmp=Pe({type:n,selectors:[[`ng-component`]],hostAttrs:[`cdk-text-field-style-loader`,``],decls:0,vars:0,template:function(i,r){},styles:[`textarea.cdk-textarea-autosize {
  resize: none;
}
