import{a as I,c as J,d as Q}from"./chunk-TXCA5Z3F.js";import{a as U,b as z,c as K,d as Y,f as G,g as X,h as q,i as Z}from"./chunk-7WI3NGJG.js";import"./chunk-ZWLPU56G.js";import{a as F,b as H}from"./chunk-UL67FB7Q.js";import{Ba as a,Ga as n,Ha as t,Ia as o,Ja as x,Ma as O,O as v,Oa as P,U as C,V as S,W as c,X as u,Y as M,Ya as T,Za as e,Zb as V,ab as b,bb as h,cb as f,da as E,db as B,eb as D,ga as _,ib as A,la as r,ma as w,pc as N,qc as L,rc as W,uc as R,xa as j}from"./chunk-ZQROOWMS.js";var g;(function(l){let k;(function(i){i.Strict="strict",i.Loose="loose",i.Antiscript="antiscript",i.Sandbox="sandbox"})(k=l.SecurityLevel||(l.SecurityLevel={}));let d;(function(i){i.Base="base",i.Forest="forest",i.Dark="dark",i.Default="default",i.Neutral="neutral"})(d=l.Theme||(l.Theme={}));let m;(function(i){i[i.Debug=1]="Debug",i[i.Info=2]="Info",i[i.Warn=3]="Warn",i[i.Error=4]="Error",i[i.Fatal=5]="Fatal"})(m=l.LogLevel||(l.LogLevel={}))})(g||(g={}));function $(l,k){if(l&1){let d=x();n(0,"button",29),O("click",function(){c(d);let i=P();return u(i.onCopyToClipboard())}),M(),n(1,"svg",30),o(2,"path",31),t()()}}var ge=(()=>{class l{constructor(d,m){this.elementRef=d,this.snackbar=m,this.clipboardButton=Q,this.emojiMarkdown="# I :heart: ngx-markdown",this.katexMarkdown="#### `katex` directive example\n\n```latex\nf(x) = \\int_{-\\infty}^\\infty \\hat f(\\xi) e^{2 \\pi i \\xi x} d\\xi\n```\n\n$f(x) = \\int_{-\\infty}^\\infty \\hat f(\\xi) e^{2 \\pi i \\xi x} d\\xi$",this.mermaidMarkdown="```mermaid\ngraph TD;\n  A-->B;\n  A-->C;\n  B-->D;\n  C-->D;\n```",this.mermaidOptions={fontFamily:"inherit",theme:g.Theme.Dark}}ngOnInit(){this.setHeadings()}onCopyToClipboard(){this.snackbar.open("Copied to clipboard via ng-template!",void 0,{duration:3e3,horizontalPosition:"right",verticalPosition:"bottom"})}setHeadings(){let d=[];this.elementRef.nativeElement.querySelectorAll("h2").forEach(m=>d.push(m)),this.headings=d}static{this.\u0275fac=function(m){return new(m||l)(w(E),w(J))}}static{this.\u0275cmp=v({type:l,selectors:[["app-plugins"]],standalone:!0,features:[B([I({clipboardOptions:{provide:V,useValue:{}},sanitize:_.NONE})]),D],decls:153,vars:34,consts:[["buttonTemplate",""],[3,"headings"],["id","emoji"],[3,"src"],["fxLayout","column","fxLayout.gt-sm","row","fxLayoutGap","16px"],["appearance","fill","color","accent","fxFlex.gt-sm","calc(50% - 8px)"],["matInput","",3,"ngModelChange","ngModel"],["emoji","","fxFlex.gt-sm","calc(50% - 8px)",3,"data"],["emoji",""],["id","line-numbers"],["lineNumbers",""],["lineNumbers","",3,"start"],["id","line-highlight"],["lineHighlight","",3,"line","lineOffset"],["id","command-line"],["commandLine","",3,"user","host","src"],["commandLine","",3,"user","host","output","src"],["commandLine","",3,"prompt","output","src"],["commandLine","",3,"prompt","filterOutput","src"],["id","katex"],["katex","","fxFlex.gt-sm","calc(50% - 8px)",3,"data"],["id","mermaid"],["mermaid","","fxFlex.gt-sm","calc(50% - 8px)",3,"data","mermaidOptions"],["id","clipboard"],["clipboard",""],["clipboard","",1,"btn-clipboard-toolbar"],["clipboard","",1,"btn-clipboard-default"],["clipboard","",3,"clipboardButtonComponent"],["clipboard","",3,"clipboardButtonTemplate"],[1,"btn-clipboard",3,"click"],["viewBox","0 0 24 24",2,"width","16px","height","16px"],["fill","#fff","d","M19,3H14.82C14.4,1.84 13.3,1 12,1C10.7,1 9.6,1.84 9.18,3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3M12,3A1,1 0 0,1 13,4A1,1 0 0,1 12,5A1,1 0 0,1 11,4A1,1 0 0,1 12,3M7,7H17V5H19V19H5V5H7V7Z"]],template:function(m,i){if(m&1){let s=x();n(0,"app-scrollspy-nav-layout",1)(1,"h1"),e(2,"Plugins"),t(),n(3,"markdown"),e(4," Before to use any plugin, make sure you've installed the required libraries by following the [installation](/get-started#installation) section of the __Get Started__ page. "),t(),n(5,"section")(6,"h2",2),e(7,"Emoji plugin"),t(),n(8,"markdown"),e(9,`
