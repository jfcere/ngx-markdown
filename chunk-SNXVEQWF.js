import{a as L,c as J,d as Q}from"./chunk-W3H32AJH.js";import"./chunk-SCWJFUWQ.js";import{a as W,b as U,c as z,d as K,f as Y,g as G,h as X,i as q,j as Z}from"./chunk-E4GMOIJ4.js";import"./chunk-BTWGBLHG.js";import{a as H}from"./chunk-V72TJ7RD.js";import{Ac as F,Da as _,Fa as r,Ka as t,La as n,Ma as o,Na as w,Qa as O,R as y,S as v,Sa as j,T as s,U as c,V as C,aa as M,ab as P,ac as A,bb as e,eb as b,fb as h,ga as S,gb as g,hb as T,hc as D,la as i,lb as B,ma as f,ra as E,vc as I,wc as V,xc as R,zc as N}from"./chunk-YRPUISPE.js";function $(u,p){if(u&1){let m=w();t(0,"button",29),O("click",function(){s(m);let d=j();return c(d.onCopyToClipboard())}),C(),t(1,"svg",30),o(2,"path",31),n()()}}var k=class u{constructor(p,m){this.elementRef=p;this.snackbar=m;this.clipboardButton=Q;this.emojiMarkdown="# I :heart: ngx-markdown";this.katexMarkdown="#### `katex` directive example\n\n```latex\nf(x) = \\int_{-\\infty}^\\infty \\hat f(\\xi) e^{2 \\pi i \\xi x} d\\xi\n```\n\n$f(x) = \\int_{-\\infty}^\\infty \\hat f(\\xi) e^{2 \\pi i \\xi x} d\\xi$";this.mermaidMarkdown="```mermaid\ngraph TD;\n  A-->B;\n  A-->C;\n  B-->D;\n  C-->D;\n```";this.mermaidOptions={fontFamily:"inherit",theme:"dark"}}ngOnInit(){this.setHeadings()}onCopyToClipboard(){this.snackbar.open("Copied to clipboard via ng-template!",void 0,{duration:3e3,horizontalPosition:"right",verticalPosition:"bottom"})}setHeadings(){let p=[];this.elementRef.nativeElement.querySelectorAll("h2").forEach(m=>p.push(m)),this.headings=p}static{this.\u0275fac=function(m){return new(m||u)(f(M),f(J))}}static{this.\u0275cmp=E({type:u,selectors:[["app-plugins"]],features:[T([L({clipboardOptions:{provide:A,useValue:{}},sanitize:S.NONE})])],decls:153,vars:34,consts:[["buttonTemplate",""],[3,"headings"],["id","emoji"],[3,"src"],["fxLayout","column","fxLayout.gt-sm","row","fxLayoutGap","16px"],["appearance","fill","color","accent","fxFlex.gt-sm","calc(50% - 8px)"],["matInput","","cdkTextareaAutosize","true",3,"ngModelChange","ngModel"],["emoji","","fxFlex.gt-sm","calc(50% - 8px)",3,"data"],["emoji",""],["id","line-numbers"],["lineNumbers",""],["lineNumbers","",3,"start"],["id","line-highlight"],["lineHighlight","",3,"line","lineOffset"],["id","command-line"],["commandLine","",3,"user","host","src"],["commandLine","",3,"user","host","output","src"],["commandLine","",3,"prompt","output","src"],["commandLine","",3,"prompt","filterOutput","src"],["id","katex"],["katex","","fxFlex.gt-sm","calc(50% - 8px)",3,"data"],["id","mermaid"],["mermaid","","fxLayoutAlign","center center","fxFlex.gt-sm","calc(50% - 8px)",3,"data","mermaidOptions"],["id","clipboard"],["clipboard",""],["clipboard","",1,"btn-clipboard-toolbar"],["clipboard","",1,"btn-clipboard-default"],["clipboard","",3,"clipboardButtonComponent"],["clipboard","",3,"clipboardButtonTemplate"],[1,"btn-clipboard",3,"click"],["viewBox","0 0 24 24",2,"width","16px","height","16px"],["fill","#fff","d","M19,3H14.82C14.4,1.84 13.3,1 12,1C10.7,1 9.6,1.84 9.18,3H5A2,2 0 0,0 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5A2,2 0 0,0 19,3M12,3A1,1 0 0,1 13,4A1,1 0 0,1 12,5A1,1 0 0,1 11,4A1,1 0 0,1 12,3M7,7H17V5H19V19H5V5H7V7Z"]],template:function(m,a){if(m&1){let d=w();t(0,"app-scrollspy-nav-layout",1)(1,"h1"),e(2,"Plugins"),n(),t(3,"markdown"),e(4," Before to use any plugin, make sure you've installed the required libraries by following the [installation](/get-started#installation) section of the __Get Started__ page. "),n(),t(5,"section")(6,"h2",2),e(7,"Emoji plugin"),n(),t(8,"markdown"),e(9,`
